#+TITLE: [[https://projecteuler.net/problem=54][Problem 54]]
...
The cards are valued in the order: =2=, =3=, =4=, =5=, =6=, =7=, =8=, =9=, =10=,
=Jack=, =Queen=, =King=, =Ace=.
...
The file, [[./poker.txt][poker.txt]], contains one-thousand random hands dealt to two
